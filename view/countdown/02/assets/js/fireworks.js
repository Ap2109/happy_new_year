...
// Gia tốc cơ bản của pháo hoa.
// 1.0 khiến pháo hoa di chuyển với tốc độ không đổi.
// Số lớn hơn tăng tốc độ pháo hoa tăng tốc theo thời gian.
const FIREWORK_ACCELERATION = 1.05;
// Độ sáng tối thiểu của pháo hoa.
const FIREWORK_BRIGHTNESS_MIN = 50;
// Độ sáng tối đa của pháo hoa.
const FIREWORK_BRIGHTNESS_MAX = 80;
// Tốc độ cơ bản của pháo hoa.
const FIREWORK_SPEED = 50;
// Độ dài cơ bản của đường pháo hoa.
const FIREWORK_TRAIL_LENGTH = 3;
// Xác định xem chỉ báo vị trí mục tiêu có được bật không.
const FIREWORK_TARGET_INDICATOR_ENABLED = true;

// Độ sáng tối thiểu của hạt.
const PARTICLE_BRIGHTNESS_MIN = 50;
// Độ sáng tối đa của hạt.
const PARTICLE_BRIGHTNESS_MAX = 80;
// Số hạt cơ bản mỗi pháo hoa.
const PARTICLE_COUNT = 100;
// Tỷ lệ suy giảm tối thiểu của hạt.
const PARTICLE_DECAY_MIN = 0.015;
// Tỷ lệ suy giảm tối đa của hạt.
const PARTICLE_DECAY_MAX = 0.03;
// Ma sát cơ bản của hạt.
// Làm chậm tốc độ của hạt theo thời gian.
const PARTICLE_FRICTION = 0.95;
// Trọng lực cơ bản của hạt.
// Tốc độ hạt di chuyển theo hướng xuống dưới.
const PARTICLE_GRAVITY = 0.7;
// Biến thiên trong màu sắc của hạt.
const PARTICLE_HUE_VARIANCE = 0;
// Độ trong suốt cơ bản của hạt.
const PARTICLE_TRANSPARENCY = 1;
// Tốc độ tối thiểu của hạt.
const PARTICLE_SPEED_MIN = 1;
// Tốc độ tối đa của hạt.
const PARTICLE_SPEED_MAX = 10;
// Độ dài cơ bản của đường hạt nổ.
const PARTICLE_TRAIL_LENGTH = 5;

// Mức alpha mà vòng lặp dọn dẹp canvas loại bỏ các đường hiện có.
// Giá trị thấp hơn tăng thời gian tồn tại của đường.
const CANVAS_CLEANUP_ALPHA = 0.15;
// Thay đổi độ của mỗi vòng lặp, được sử dụng để quay qua các màu pháo hoa khác nhau.
const HUE_STEP_INCREASE = 0.5;

// Số tick tối thiểu giữa mỗi lần phóng pháo hoa thủ công.
const TICKS_PER_FIREWORK_MIN = 5;
// Số tick tối thiểu giữa mỗi lần phóng pháo hoa tự động.
const TICKS_PER_FIREWORK_AUTOMATED_MIN = 20;
// Số tick tối đa giữa mỗi lần phóng pháo hoa tự động.
